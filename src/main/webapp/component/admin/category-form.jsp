        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${categories}" var="category">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="/admin/category/update?id=${category.id}">Go to update page</a>
                        <a class="btn btn-danger" href="/admin/category/remove?id=${category.id}">Remove</a>
                    </td>
                </tr>
            </c:forEach>
